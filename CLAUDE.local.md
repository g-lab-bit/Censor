...
**YOU ARE IN: `Censor/polecats/dementus/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/Censor/` (rig root) or other directories
...
**Your mail address:** `Censor/polecats/dementus`
**Your rig:** Censor
**Your Witness:** `Censor/witness`
...
| Ask Witness for help | `gt mail send Censor/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`Censor/witness`) when:
...
```bash
gt mail send Censor/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
